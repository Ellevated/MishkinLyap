...
model: sonnet
effort: high
tools: mcp__exa__web_search_exa, mcp__exa__web_fetch_exa, Read, Write
---
...
- `mcp__exa__web_fetch_exa` — read a candidate page in full when the snippet is too thin
...
### Compute Cost
**Estimate:** ~$1 (R0: low risk) / Easy for human teams
...
### Compute Cost
**Estimate:** ~$5 (R1: medium risk) / Medium for human teams
...
### Compute Cost
**Estimate:** ~$15 (R2: high risk) / Hard for human teams
